...
namespace DeliveryRushExam.UI
{
    public class UIManager : MonoBehaviour
    {
        ...
        private ScorePopupPool popupPool;
        ...
        private void ShowScorePopup(OrderData order)
        {
            if (popupPool == null)
            {
                popupPool = FindFirstObjectByType<ScorePopupPool>();
                if (popupPool == null)
                {
                    GameObject poolGO = new GameObject("ScorePopupPool");
                    popupPool = poolGO.AddComponent<ScorePopupPool>();
                    popupPool.popupPrefab = scorePopupPrefab;
                }
            }
            
            ScorePopupView popup = popupPool.GetPopup();
            ...
            popup.Setup("+" + order.rewardPoints + " points", popupPool);
        }
    }
}